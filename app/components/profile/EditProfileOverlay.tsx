                ...
                <div className={`h-[calc(500px-200px)] ${!uploadedImage ? 'mt-16' : 'mt-[58px]'}`}>
                        ...
                        {!uploadedImage ? ( 
                            ...
                            <div className="w-full max-h-[420px] mx-auto bg-black circle-stencil">
                                <Cropper stencilProps={{ aspectRatio: 1 }} className='h-[400px]' onChange={(cropper) => setCropper(cropper.getCoordinates())} src={uploadedImage} />
                            </div>
                        )}
                </div>
                ...
                <div id='ButtonSection' className='absolute p-5 left-0 bottom-0 border-t border-t-gray-300 w-full'>
                        {!uploadedImage ? (
                            <div id='UpdateInfoButtons' className='flex items-center justify-end'>
                                <button disabled={isUpdating} onClick={() => setIsEditProfileOpen(false)} className='flex items-center border rounded-sm px-3 py-[6px] hover:bg-gray-100'>
                                    <span className='px-2 font-medium text-[15px]'>Cancel</span>
                                </button>

                                <button disabled={isUpdating} onClick={() => updateUserInfo()} className='flex items-center bg-[#F02c56] text-white border rounded-md ml-3 px-3 py-[6px]'>
                            ...
                            <div id='CropperButtons' className='flex items-center justify-end'>
                                <button onClick={() => setUploadedImage(null)} className='flex items-center border rounded-sm px-3 py-[6px] hover:bg-gray-100'>
                                    <span className='px-2 font-medium text-[15px]'>Cancel</span>
                                </button>
