                ...
                <div id='ButtonSection' className='absolute p-5 left-0 bottom-0 border-t border-t-gray-300 w-full'>
                        {!uploadedImage ? (
                            <div id='UpdateInfoButtons' className='flex items-center justify-end'>
                                <button disabled={isUpdating} className='flex items-center border rounded-sm px-3 py-[6px] hover:bg-gray-100'>
                                    <span className='px-2 font-medium text-[15px]'>Cancel</span>
                                </button>

                                <button disabled={isUpdating} className='flex items-center bg-[#F02c56] text-white border rounded-md ml-3 px-3 py-[6px]'>
