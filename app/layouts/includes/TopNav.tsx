            ...
            <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : ''}`}>
                ...
                <div className='relative hidden md:flex items-center justify-end bg-[#F1F1f2] p-1 rounded-full max-w-[430px] w-full'>
                    ...
                    <div className='absolute bg-white max-w-[910px] h-auto w-full z-20 left-0 top-12 border p-1'>
                        <div className='p-1'>
                            <Link href={'/profile/1'} className='flex items-center justify-between w-full cursor-pointer hover:bg-[#F12856] p-1 px-2 hover:text-white'>
                                <div className='flex items-center'>
                                    <img src="https://placehold.co/40" className='rounded-md' width={40} alt="i" />
                    ...
                    {true ? (
                        ...
                        <div className='flex items-center'>
                            <div className='relative'>
                                <button className='ml-1 border border-gray-200 rounded-full'>
                                    <img className='rounded-full w-[35px] h-[35px]' src="https://placehold.co/35" alt="i" />
                                </button>
